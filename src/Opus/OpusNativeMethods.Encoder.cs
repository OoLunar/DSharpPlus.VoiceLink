...
namespace DSharpPlus.VoiceLink.Opus
{
    internal static partial class OpusNativeMethods
    {
        ...
        public static unsafe partial int EncoderGetSize(int channels);
        ...
        public static unsafe partial OpusEncoder* EncoderCreate(OpusSampleRate sampleRate, int channels, OpusApplication application, out OpusErrorCode* error);

        /// <summary>
        /// Initializes a previously allocated encoder state. The memory pointed to by <paramref name="encoder"/> must be at least the size returned by <see cref="EncoderGetSize(int)"/>. This is intended for applications which use their own allocator instead of malloc.
        /// </summary>
        ...
        public static unsafe partial OpusErrorCode EncoderInit(OpusEncoder* encoder, OpusSampleRate sampleRate, int channels, OpusApplication application);
        ...
        public static unsafe partial void EncoderDestroy(OpusEncoder* encoder);
        ...
        public static unsafe partial OpusErrorCode EncoderControl(OpusEncoder* encoder, int request, int value);
    }
}
