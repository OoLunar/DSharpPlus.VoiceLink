...
namespace DSharpPlus.VoiceLink.Opus
{
    internal static partial class OpusNativeMethods
    {
        ...
        public static unsafe partial OpusEncoder* EncoderCreate(OpusSampleRate sampleRate, int channels, OpusApplication application, out OpusError* error);
        ...
        public static unsafe partial OpusError EncoderInit(OpusEncoder* encoder, OpusSampleRate sampleRate, int channels, OpusApplication application);
        ...
        public static unsafe partial int Encode(OpusEncoder* encoder, short* pcm, int frameSize, out byte* data, int maxDataBytes);
        ...
        public static unsafe partial int EncodeFloat(OpusEncoder* encoder, short* pcm, int frameSize, out byte* data, int maxDataBytes);
        ...
        public static unsafe partial OpusError EncoderControl(OpusEncoder* encoder, OpusControl request, int value);
    }
}
